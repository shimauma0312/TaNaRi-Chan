  ...
  const handleToggleCompletion = async (todoId: number) => {
    try {
      ...
      setTodoList((prevList) =>
        prevList.map((todo) => (todo.todo_id === todoId ? updatedTodo : todo)),
      )
    } catch (error) {
              ...
              <div className="mb-6 flex gap-4">
                ...
                <div className="bg-green-500/20 border border-green-500 rounded-lg p-3">
                  ...
                  <div className="text-xl font-bold">
                    {todoList.filter((todo) => todo.is_completed).length}
                  </div>
                </div>
                  ...
                  >
                    <div className="flex items-start justify-between">
                      <div className="flex-1">
                        ...
                        <p
                          className={`text-gray-300 mb-2 ${todo.is_completed ? "line-through" : ""}`}
                        >
                          {todo.description}
                        </p>
